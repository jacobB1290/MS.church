...
<!-- v1.49.35 - /about: combine Our Mission + Our Story into one unified section using the editorial split layout (no .section-card frame). See src/index.tsx for the full change log. -->
<html lang="en">
${homeHead()}
${homeBody()}
${homeScripts()}
