...
<!-- v1.50.2 - /outreach map extended on desktop to a 2.9:1 widescreen variant (same artwork, wider canvas). Mobile SVG preserved verbatim. See src/index.tsx for the full change log. -->
<html lang="en">
${homeHead()}
${homeBody()}
${homeScripts()}
