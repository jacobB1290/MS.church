...
<!-- v1.38.0 - SEO audit scoring fixes: dynamic Event dates, DST-aware timezone, FAQPage schema, Tuesday/Thursday Event schemas, viewport accessibility, Twitter card typo, aria-live carousel -->
<html lang="en">
${homeHead()}
${homeBody()}
${homeScripts()}
