...
const DEMO_SERMON: PublishedSermon = {
  ...
  seo: null,
  segments: [
    { startSec: 0, endSec: 200, type: 'welcome', title: 'Welcome', summary: '', speakers: [], scriptureRefs: [], children: [] },
    { startSec: 200, endSec: 725, type: 'worship', title: 'Worship', summary: '', speakers: [], scriptureRefs: [], children: [] },
    { startSec: 725, endSec: 880, type: 'scripture', title: 'Scripture reading', summary: '', speakers: [], scriptureRefs: ['Romans 10'], children: [] },
    { startSec: 880, endSec: 2350, type: 'sermon', title: 'The Message', summary: 'Faith comes by hearing', speakers: ['Pastor John'], scriptureRefs: ['Romans 10:14-17'], children: [] },
    { startSec: 2350, endSec: 2670, type: 'prayer', title: 'Prayer & response', summary: '', speakers: [], scriptureRefs: [], children: [] },
    { startSec: 2670, endSec: 2880, type: 'worship', title: 'Closing song', summary: '', speakers: [], scriptureRefs: [], children: [] },
  ],
  songs: [
