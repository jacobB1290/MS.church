                    ...
                    <div class="section-card">
                        <div class="schedule-grid" data-reveal-sync>
                            ...
                            <a class="schedule-item teaser-link-card reveal-rise" href="/outreach#meals-hospitality">
                                ...
                                <div class="schedule-item-image">
                                    <picture>
                                        <source media="(min-width: 961px)" srcset="/static/cooking-ministry-desktop.avif" type="image/avif">
                                        <source media="(min-width: 961px)" srcset="/static/cooking-ministry-desktop.webp" type="image/webp">
                                        <source media="(min-width: 961px)" srcset="/static/cooking-ministry-desktop.jpg">
