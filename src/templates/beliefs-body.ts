        ...
        <div class="page">
            ...
            <main>
                <section id="beliefs-intro">
                    ...
                    <p class="section-lead">These eleven convictions, adopted from our parent congregation, are the doctrinal ground beneath everything we teach, sing, pray, and serve. We hold to the whole counsel of Scripture — grace and truth, with no watered-down version.</p>
                </section>
                ...
                <section id="beliefs-cta">
                    ...
                    <div class="section-card visit-final-cta">
                        <p class="section-lead">If anything here raises a question, sparks a conversation, or stirs something you want to talk through — we're here. Reach out and we'll get you everything you need.</p>
